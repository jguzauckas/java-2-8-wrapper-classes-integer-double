# AP Computer Science A - Unit 2 Section 8

# Wrapper Classes: `Integer` and `Double`

This section of the objects unit is meant to redefine our primitive types as objects to further our understanding of object-oriented programming.
